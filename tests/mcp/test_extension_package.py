...
def test_extension_package_imports_without_omni(monkeypatch) -> None:
    ...
    extension_root = repo_root / "exts" / "khemoo.simul"
    ...
    for module_name in (
        "khemoo.simul.extension",
        "khemoo.simul.lifecycle",
        "khemoo.simul.ui_builder",
    ):
        sys.modules.pop(module_name, None)

    module = importlib.import_module("khemoo.simul.extension")
